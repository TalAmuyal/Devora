...
if [[ -n "$USE_FABLE" ]]; then
	...
	export ANTHROPIC_DEFAULT_OPUS_MODEL="$CC_OPUS_4_8"
	export ANTHROPIC_DEFAULT_SONNET_MODEL="$CC_OPUS_4_8"
fi
...
CLAUDE_CODE_ADDITIONAL_DIRECTORIES_CLAUDE_MD=1 claude --effort xhigh --permission-mode plan "${ARGS[@]}"
