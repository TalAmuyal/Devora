 ...
 *
 * A `modalLayer` (see `./ModalDialog`): Escape/`q` cancel; Enter creates the task from the title but toggles the active repo when the filter is focused (so the list keeps its keyboard nav).
