...
- Settings Hub: a text/model field now shows a Save button next to its input while it holds an unsaved value, making the commit gesture discoverable instead of relying on a hidden Enter keypress
